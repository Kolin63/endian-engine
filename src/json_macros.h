...
// - const char* mod_name
// - int error
#define END_JSON_CHECK_NUMBER(_iter) END_JSON_CHECK_NUMBER_RET(_iter, continue);
...
// - const char* mod_name
// - int error
#define END_JSON_CHECK_STRING(_iter) END_JSON_CHECK_STRING_RET(_iter, continue);
...
// - const char* mod_name
// - int error
#define END_JSON_CHECK_STRING_LENGTH(_iter, min, max) END_JSON_CHECK_STRING_LENGTH_RET(_iter, continue, min, max);
